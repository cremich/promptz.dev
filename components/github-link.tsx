...
export function GitHubLink({ content, className }: GitHubLinkProps) {
  ...
  return (
    <a
      ...
      className={className || "inline-flex items-center gap-2 text-sm text-blue-600 dark:text-blue-400 hover:underline"}
    >
